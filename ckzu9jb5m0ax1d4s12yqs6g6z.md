...
![Screenshot of the Cosmic CMS App Search Page](https://cdn.hashnode.com/res/hashnode/image/upload/v1645300648015/Adm9Tz95Q.png)
...
![Screenshot of the Cosmic CMS Dashboard after creating a bucket](https://cdn.hashnode.com/res/hashnode/image/upload/v1645300650119/HZZLE2_1S.png)
...
![Screenshot of the app running locally but encountering an error due to no environment variables being set](https://cdn.hashnode.com/res/hashnode/image/upload/v1645300651922/eUgEYjopZ.png)
...
![Screenshot of the Vercel project view with the Import Project button highlighted](https://cdn.hashnode.com/res/hashnode/image/upload/v1645300655924/2sJ9M7Shf_.png)
...
![Screenshot of the Cosmic CMS Post data type editing page with Save Draft button highlighted](https://cdn.hashnode.com/res/hashnode/image/upload/v1645300657314/PFjpavNJS.png)

The `Save Draft` button

We now have unpublished changes. Run the app locally with `yarn dev` and then click "Preview" right under "Save Draft".

![Screenshot of the example blog running on a local machine with the preview edits being shown](https://cdn.hashnode.com/res/hashnode/image/upload/v1645300659202/DjrH77EQF.png)
...
![Screenshot of the Vercel webhook settings](https://cdn.hashnode.com/res/hashnode/image/upload/v1645300661288/K16hWZv7W.png)
...
![Screenshot of the Cosmic CMS webhooks settings](https://cdn.hashnode.com/res/hashnode/image/upload/v1645300663318/3VFdUb7fNy.png)
...
> Like this post? [Subscribe to my email newsletter](https://mailchi.mp/f91826b80eb3/alecbrunelleemailsignup) for more like it in the future.